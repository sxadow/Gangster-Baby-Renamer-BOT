...
FORCE_SUB = os.environ.get("FORCE_SUB", "TVHD10") 

DB_NAME = os.environ.get("DB_NAME","Cluster0")     

DB_URL = os.environ.get("DB_URL","mongodb+srv://tronn:tronn@cluster0.g9hwdft.mongodb.net/?retryWrites=true&w=majority")
